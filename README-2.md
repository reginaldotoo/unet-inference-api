...
Download the trained model and normalization parameters from Hugging Face:

👉 [huggingface.co/reggieoo/unet-crop-classification](https://huggingface.co/reggieoo/unet-crop-classification)

## Sample Data

Download the satellite composites for all four sites:

👉 [Google Drive — sample data](https://drive.google.com/drive/folders/1871zXvwx9pVp5PugQEhe61naBnxT68ja?usp=share_link)

Place the model files and site folders together in one directory before running.
